    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-3xl font-bold">{events.reduce((acc, event) => acc + event.salesCount, 0)}</div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-3xl font-bold">{events.reduce((acc, event) => acc + event.viewCount, 0)}</div>
          </CardContent>
        </Card>
      </div>
                  ...
                  <div className="grid grid-cols-3 gap-4 mt-4">
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        ...
                        <p className="font-medium">{event.salesCount}</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        ...
                        <p className="font-medium">{event.viewCount}</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-2">

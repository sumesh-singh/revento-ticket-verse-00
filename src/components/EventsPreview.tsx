...
const EventsPreview = ({ isLoggedIn }: EventPreviewProps) => {
  ...
  // Sample events data with better images
  const events = [
    {
      id: 1,
      ...
      image: 'https://images.unsplash.com/photo-1540317580384-e5d43867caa6?ixlib=rb-4.0.3&auto=format&fit=crop&w=1470&q=80',
      category: 'Technology',
      attendees: 1240
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1459749411175-04bf5292ceea?ixlib=rb-4.0.3&auto=format&fit=crop&w=1470&q=80',
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1501339847302-ac426a4a7cbb?ixlib=rb-4.0.3&auto=format&fit=crop&w=1470&q=80',
      category: 'Business',
      attendees: 380
    }
  ];
